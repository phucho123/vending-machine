...
set_property PACKAGE_PIN U19 [get_ports {io_ledcan[0]}]
set_property PACKAGE_PIN V19 [get_ports {io_ledcan[1]}]
set_property PACKAGE_PIN W18 [get_ports {io_ledcan[2]}]
set_property PACKAGE_PIN U15 [get_ports {io_ledcan[3]}]
set_property PACKAGE_PIN U14 [get_ports {io_ledcan[4]}]
set_property PACKAGE_PIN V14 [get_ports {io_ledcan[5]}]
set_property PACKAGE_PIN V13 [get_ports {io_ledcan[6]}]
set_property PACKAGE_PIN V3  [get_ports {io_ledcan[7]}]
set_property PACKAGE_PIN W3  [get_ports {io_ledcan[8]}]
set_property PACKAGE_PIN U3  [get_ports {io_ledcan[9]}]
set_property PACKAGE_PIN P3  [get_ports {io_ledcan[10]}]
...
set_property PACKAGE_PIN C16 [get_ports {io_btn}]
